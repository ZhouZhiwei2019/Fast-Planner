...
{
template <class ContainerAllocator> struct SparseMap3D_
{
...
template <typename ContainerAllocator> std::ostream& operator<<(std::ostream& s, const ::multi_map_server::SparseMap3D_<ContainerAllocator>& v)
{
...
namespace message_traits
{
    ...
    template <class ContainerAllocator> struct MD5Sum<::multi_map_server::SparseMap3D_<ContainerAllocator>>
    {
    ...
    template <class ContainerAllocator> struct DataType<::multi_map_server::SparseMap3D_<ContainerAllocator>>
    {
        static const char* value()
        {
    ...
    template <class ContainerAllocator> struct Definition<::multi_map_server::SparseMap3D_<ContainerAllocator>>
    {
        static const char* value()
        {
...
namespace message_operations
{
    ...
    template <class ContainerAllocator> struct Printer<::multi_map_server::SparseMap3D_<ContainerAllocator>>
    {
