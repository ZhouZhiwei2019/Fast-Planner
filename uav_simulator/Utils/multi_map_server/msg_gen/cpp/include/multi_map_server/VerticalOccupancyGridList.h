...
{
template <class ContainerAllocator> struct VerticalOccupancyGridList_
{
...
template <typename ContainerAllocator> std::ostream& operator<<(std::ostream& s, const ::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator>& v)
{
...
namespace message_traits
{
    ...
    template <class ContainerAllocator> struct MD5Sum<::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator>>
    {
    ...
    template <class ContainerAllocator> struct DataType<::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator>>
    {
        static const char* value()
        {
    ...
    template <class ContainerAllocator> struct Definition<::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator>>
    {
        static const char* value()
        {
            return "float32 x\n\
...
namespace message_operations
{
    ...
    template <class ContainerAllocator> struct Printer<::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator>>
    {
        template <typename Stream>
        static void stream(Stream& s, const std::string& indent, const ::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator>& v)
        {
            s << indent << "x: ";
