...
{
template <class ContainerAllocator> struct PositionCommand_
{
...
template <typename ContainerAllocator> std::ostream& operator<<(std::ostream& s, const ::quadrotor_msgs::PositionCommand_<ContainerAllocator>& v)
{
...
namespace message_traits
{
    ...
    template <class ContainerAllocator> struct MD5Sum<::quadrotor_msgs::PositionCommand_<ContainerAllocator>>
    {
    ...
    template <class ContainerAllocator> struct DataType<::quadrotor_msgs::PositionCommand_<ContainerAllocator>>
    {
        static const char* value()
        {
    ...
    template <class ContainerAllocator> struct Definition<::quadrotor_msgs::PositionCommand_<ContainerAllocator>>
    {
        static const char* value()
        {
...
namespace message_operations
{
    ...
    template <class ContainerAllocator> struct Printer<::quadrotor_msgs::PositionCommand_<ContainerAllocator>>
    {
