...
{
template <class ContainerAllocator> struct PPROutputData_
{
    typedef PPROutputData_<ContainerAllocator> Type;

    PPROutputData_()
        : header(), quad_time(0), des_thrust(0.0), des_roll(0.0), des_pitch(0.0), des_yaw(0.0), est_roll(0.0), est_pitch(0.0), est_yaw(0.0), est_angvel_x(0.0),
          est_angvel_y(0.0), est_angvel_z(0.0), est_acc_x(0.0), est_acc_y(0.0), est_acc_z(0.0), pwm()
    {
        pwm.assign(0);
    }

    PPROutputData_(const ContainerAllocator& _alloc)
        : header(_alloc), quad_time(0), des_thrust(0.0), des_roll(0.0), des_pitch(0.0), des_yaw(0.0), est_roll(0.0), est_pitch(0.0), est_yaw(0.0),
          est_angvel_x(0.0), est_angvel_y(0.0), est_angvel_z(0.0), est_acc_x(0.0), est_acc_y(0.0), est_acc_z(0.0), pwm()
    {
        pwm.assign(0);
    }
...
template <typename ContainerAllocator> std::ostream& operator<<(std::ostream& s, const ::quadrotor_msgs::PPROutputData_<ContainerAllocator>& v)
{
...
namespace message_traits
{
    ...
    template <class ContainerAllocator> struct MD5Sum<::quadrotor_msgs::PPROutputData_<ContainerAllocator>>
    {
    ...
    template <class ContainerAllocator> struct DataType<::quadrotor_msgs::PPROutputData_<ContainerAllocator>>
    {
        static const char* value()
        {
    ...
    template <class ContainerAllocator> struct Definition<::quadrotor_msgs::PPROutputData_<ContainerAllocator>>
    {
        static const char* value()
        {
...
namespace message_operations
{
    ...
    template <class ContainerAllocator> struct Printer<::quadrotor_msgs::PPROutputData_<ContainerAllocator>>
    {
