...
{
template <class ContainerAllocator> struct OutputData_
{
    typedef OutputData_<ContainerAllocator> Type;

    OutputData_()
        : header(), loop_rate(0), voltage(0.0), orientation(), angular_velocity(), linear_acceleration(), pressure_dheight(0.0), pressure_height(0.0),
          magnetic_field(), radio_channel(), seq(0)
    {
        radio_channel.assign(0);
    }

    OutputData_(const ContainerAllocator& _alloc)
        : header(_alloc), loop_rate(0), voltage(0.0), orientation(_alloc), angular_velocity(_alloc), linear_acceleration(_alloc), pressure_dheight(0.0),
          pressure_height(0.0), magnetic_field(_alloc), radio_channel(), seq(0)
    {
        radio_channel.assign(0);
    }
...
template <typename ContainerAllocator> std::ostream& operator<<(std::ostream& s, const ::quadrotor_msgs::OutputData_<ContainerAllocator>& v)
{
...
namespace message_traits
{
    ...
    template <class ContainerAllocator> struct MD5Sum<::quadrotor_msgs::OutputData_<ContainerAllocator>>
    {
    ...
    template <class ContainerAllocator> struct DataType<::quadrotor_msgs::OutputData_<ContainerAllocator>>
    {
        static const char* value()
        {
    ...
    template <class ContainerAllocator> struct Definition<::quadrotor_msgs::OutputData_<ContainerAllocator>>
    {
        static const char* value()
        {
...
namespace message_operations
{
    ...
    template <class ContainerAllocator> struct Printer<::quadrotor_msgs::OutputData_<ContainerAllocator>>
    {
