...
{
template <class ContainerAllocator> struct Gains_
{
...
template <typename ContainerAllocator> std::ostream& operator<<(std::ostream& s, const ::quadrotor_msgs::Gains_<ContainerAllocator>& v)
{
...
namespace message_traits
{
    ...
    template <class ContainerAllocator> struct MD5Sum<::quadrotor_msgs::Gains_<ContainerAllocator>>
    {
    ...
    template <class ContainerAllocator> struct DataType<::quadrotor_msgs::Gains_<ContainerAllocator>>
    {
        static const char* value()
        {
    ...
    template <class ContainerAllocator> struct Definition<::quadrotor_msgs::Gains_<ContainerAllocator>>
    {
        static const char* value()
        {
            return "float64 Kp\n\
...
namespace message_operations
{
    ...
    template <class ContainerAllocator> struct Printer<::quadrotor_msgs::Gains_<ContainerAllocator>>
    {
